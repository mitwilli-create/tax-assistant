...
| Phase | Features & Enhancements |
|---|---|
| 1.2 Q3 2026 | Year-over-year data carryforward: automatically import prior-year AGI, carryforward losses, and state credits |
...
| Phase | Features & Enhancements |
|---|---|
| 2.1 Q4 2026 | Deduction discovery interview: structured, adaptive questionnaire that surfaces overlooked deductions (home office, professional development, medical, charitable) |
...
| Phase | Features & Enhancements |
|---|---|
| 2.2 Q1 2027 | Multi-year tax projection model: forecast 2027-2030 liability under multiple income scenarios (RSU cliff vesting, covered call income, salary increases) |
...
| Phase | Features & Enhancements |
|---|---|
| 3.1 Q2 2027 | Audit defense dossier generator: compile supporting documentation for each Schedule D entry, RSU lot, and deduction claim |
...
| Phase | Features & Enhancements |
|---|---|
| 3.2 Q3 2027 | Multi-user mode: support for household or advisor-shared access with role-based document permissions |
...
|---|---|---|---|
| 1099-B automated ingestion | High | Medium | Planned — Q2 2026 |
| RSU lot reconciliation tool | High | High | Planned — Q2 2026 |
| Multi-state wage allocator | High | Medium | Planned — Q2 2026 |
| FreeTaxUSA alert interpreter | High | Low | Planned — Q3 2026 |
| Withholding optimizer (W-4) | High | Medium | Planned — Q3 2026 |
| Deduction discovery interview | Medium | Medium | Planned — Q4 2026 |
| Covered call tax engine | Medium | High | Planned — Q4 2026 |
| Multi-year projection model | Medium | High | Planned — Q1 2027 |
| Audit defense dossier | Medium | High | Planned — Q2 2027 |
| CPA handoff package | Low | Medium | Planned — Q3 2027 |
| Estimated payment scheduler | Low | Low | Planned — Q3 2027 |
