...
The filer will take the standard deduction. No itemized deduction analysis required unless charitable contributions, mortgage interest, or state taxes paid exceed $15,000 in aggregate — which is unlikely given WA residency (no state income tax) and no mortgage.
